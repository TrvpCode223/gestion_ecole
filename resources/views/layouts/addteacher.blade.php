...
<input class="form-control" type="text" placeholder="Recherchez ici">
...
<li><a class="active" href="{{url('/add-teacher')}}"><span>Ajouter un Professeur</span></a></li>
...
<li class="submenu">
<a href="javascript:void(0);"><span>Emails</span> <span class="menu-arrow"></span></a>
<ul style="display: none;">
...
<li><a href="form-fileupload.html">Téléchargement de Fichiers </a></li>
</ul>
</li>
<li class="submenu">
...
<h5 class="text-uppercase mb-0 mt-0 page-title">ajouter un Professeur</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<ul class="breadcrumb float-right p-0 mb-0">
<li class="breadcrumb-item"><a href="{{url('/index')}}"><i class="fas fa-home"></i> Accueil</a></li>
<li class="breadcrumb-item"><a href="{{url('/index')}}">Professeur</a></li>
<li class="breadcrumb-item"><span> Ajouter un Professeur</span></li>
</ul>
</div>
</div>
</div>
...
<form>
<div class="form-group">
<label>Choisisez une image</label>
