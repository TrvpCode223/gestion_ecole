...
<ul class="sidebar-ul">
<li>
<a href="index.html" class="border-top-0"><i class="fas fa-home back-icon"></i> Back to Home</a>
</li>
<li class="menu-title">Settings</li>
<li>
<a href="settings.html">School Settings</a>
</li>
<li>
...
<li class="active">
<a href="{{url('/notifications-settings')}}">Notifications</a>
</li>
<li>
